...
import { downloadGoatReportsCSV } from "../services/csvDownload";
import { supabase } from "../services/supabaseClient";
import { useSession } from "../hooks/useSession";               // ✅ add this
import Card from "../components/Card";
import Navbar from "../components/Navbar";
// import TemperatureGraph from "../components/TemperatureGraph"; // ✅ Hidden for now
...
export default function Dashboard() {
  ...
  // Try a few common places Google OAuth puts the name:
  const name =
  ...
  return (
    <div style={{
      ...
      {/* 👇 Heading changes based on auth */}
      <h1 style={{ fontSize: "2rem", fontWeight: "bold", marginBottom: "20px" }}>
        {isLoggedIn
          ? t("hiName", { name, defaultValue: `Hi, ${name}` })
          : t("home")}
      </h1>
